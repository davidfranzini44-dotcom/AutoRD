...
export const vehicles = [
  {
    ...
    trim: 'EX-L', transmission: 'Automática', fuel: 'Gasolina', engine: '1.5L Turbo', drivetrain: '4x2',
  ...
  },
  {
    ...
    trim: 'LE', transmission: 'Automática', fuel: 'Gasolina', engine: '2.5L', drivetrain: '4x4',
    mileage: 60000, color: 'Blanco', bodyType: 'SUV',
    price: 1195000, condition: 'Usado', certified: true,
    location: 'Santo Domingo', dealer: 'Top Auto RD', dealerVerified: true,
    financing: true, tone: '#e2e8f0',
    monthly: 27200, downPct: 20, apr: 9.75, termYears: 7,
    photos: 18,
    description:
  ...
  },
  {
    ...
    mileage: 15000, color: 'Gris grafito', bodyType: 'SUV',
    price: 1450000, condition: 'Usado', certified: false,
    location: 'Santo Domingo', dealer: 'Autoimport SRL', dealerVerified: true,
    financing: true, tone: '#334155',
    monthly: 32900, downPct: 20, apr: 8.95, termYears: 7,
    photos: 30,
    description:
